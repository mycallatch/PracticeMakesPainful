...
public class PlayerTwoAttack : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Time.time >= delay && Input.GetKeyDown(KeyCode.Period))
        {
            kick = true;
    ...
    private void Punch()
    {
        ...
        {
            opp.GetComponent<PlayerOneImpact>().PlayerPunched(punchD);
            punchKnockback(opp);
            break;
        }
    }
    ...
    void Kick()
    {
        ...
        {
            opp.GetComponent<PlayerOneImpact>().PlayerKicked(kickD);
            kickKnockback(opp);
            break;
        }
    }
